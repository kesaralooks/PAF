...
public class ItemSeller {
	...
	public String insertItem(@FormParam("itemCode") String itemCode, @FormParam("itemName") String itemName,
			@FormParam("itemPrice") String itemPrice, @FormParam("sellerID") String sellerID) {
		String output = itemObj.insertItem(itemCode, itemName, itemPrice, sellerID);
		return output;
	}
	...
	public String updateItem(String itemData) {
		...
		String output = itemObj.updateItem(itemID, itemCode, itemName, itemPrice, sellerID);
		return output;
	}
